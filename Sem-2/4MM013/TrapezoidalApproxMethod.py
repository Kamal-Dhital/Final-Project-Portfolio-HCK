...
def plot_function(func, a, b):
    ...
    y = func(x)
    plt.plot(x, y)
    plt.title("Graph of the Function:  y = np.exp(x)\n Name: Kamal Dhital \n Student ID: 2407046")
    plt.xlabel("x")
    plt.ylabel("f(x)")
    plt.grid(True)
    plt.show()
...
if __name__ == "__main__":
    ...
    trapezoidal_approx_2 = trapezoidal_approx(func_2, a1, b1, N1)
    ...
    definite_integral_2 = antiderivative_2(b1) - antiderivative_2(a1)  # For 2nd Function
